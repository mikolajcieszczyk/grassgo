...
export default class EcoIntermediateForm extends Component {
    constructor() {
        ...
        this.state = {
            ...
            whichPackage: "Earth Eco Package: ADVANCED",
                        ...
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    ...
                                    id="advancedCleanup"
                                    name="advancedCleanup"
                                    value="CleanUp"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedCleanup">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    id="advancedHedgeTrim"
                                    name="advancedHedgeTrim"
                                    value="Hedge Trim"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedHedgeTrim">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="advancedTreeSurgery"
                                    id="advancedTreeSurgery"
                                    value="Tree Surgery"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedTreeSurgery">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="advancedLawnCare"
                                    id="advancedLawnCare"
                                    value="Lawn care"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedLawnCare">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="advancedPlanting"
                                    id="advancedPlanting"
                                    value="Planting"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedPlanting">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="advancedPruning"
                                    id="advancedPruning"
                                    value="Pruning"
                                />
                                <label className="ml-3 form-label" htmlFor="advancedPruning">
                                    pruning
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    class="my-checkbox styled-checkbox"
                                    id="advancedKnotweed"
                                    name="advancedKnotweed"
                                    value="Japanese Knotweed removal"
                                />
                                <label className="ml-3 form-label japanese w-100" htmlFor="advancedKnotweed">
                        ...
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    onClick={this.translateCleanup}
                                    type="checkbox"
                                    id="advanced-cleanup-only"
                                    name="cleanup"
                                    value="CleanUp"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-cleanup-only">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateHedgeTrim}
                                    type="checkbox"
                                    id="advanced-hedgeTrim-only"
                                    name="hedgeTrim"
                                    value="Hedge Trim"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-hedgeTrim-only">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateTreeSurgery}
                                    type="checkbox"
                                    id="advanced-treeSurgery-only"
                                    name="treeSurgery"
                                    value="Tree Surgery"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-treeSurgery-only">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateLawnCare}
                                    type="checkbox"
                                    id="advanced-lawnCare-only"
                                    name="lawnCare"
                                    value="Lawn care"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-lawnCare-only">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePlanting}
                                    type="checkbox"
                                    id="advanced-planting-only"
                                    name="planting"
                                    value="Planting"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-planting-only">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePruning}
                                    type="checkbox"
                                    id="advanced-pruning-only"
                                    name="pruning"
                                    value="Pruning"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="advanced-pruning-only">
                                    pruning
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateKnotweed}
                                    type="checkbox"
                                    id="advanced-knotweed-only"
                                    name="knotweed"
                                    value="Japanese Knotweed removal"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label w-100 japanese" htmlFor="advanced-knotweed-only">
                                    japanese knotweed removal
                </label>
                            </div>
                        </div>
