...
export default class EcoBasicForm extends Component {
    constructor() {
        super();
        this.state = {
            ...
            whichPackage: "Earth Eco Package: BASIC",
                        ...
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    ...
                                    value="CleanUp"
                                />
                                <label className="ml-3 form-label" htmlFor="basicCleanup">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Hedge Trim"
                                />
                                <label className="ml-3 form-label" htmlFor="basicHedgeTrim">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="basicTreeSurgery"
                                    id="basicTreeSurgery"
                                    value="Tree Surgery"
                                />
                                <label className="ml-3 form-label" htmlFor="basicTreeSurgery">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Lawn care"
                                />
                                <label className="ml-3 form-label" htmlFor="basicLawnCare">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Planting"
                                />
                                <label className="ml-3 form-label" htmlFor="basicPlanting">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Pruning"
                                />
                                <label className="ml-3 form-label" htmlFor="basicPruning">
                                    pruning
                </label>
                            </div>
                            <div>
                                ...
                                />
                                <label className="ml-3 form-label japanese w-100" htmlFor="basicKnotweed">
                        ...
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    onClick={this.translateCleanup}
                                    type="checkbox"
                                    id="basic-cleanup-only"
                                    name="cleanup"
                                    value="CleanUp"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-cleanup-only">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateHedgeTrim}
                                    type="checkbox"
                                    id="basic-hedgeTrim-only"
                                    name="hedgeTrim"
                                    value="Hedge Trim"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-hedgeTrim-only">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateTreeSurgery}
                                    type="checkbox"
                                    id="basic-treeSurgery-only"
                                    name="treeSurgery"
                                    value="Tree Surgery"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-treeSurgery-only">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateLawnCare}
                                    type="checkbox"
                                    id="basic-lawnCare-only"
                                    name="lawnCare"
                                    value="Lawn care"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-lawnCare-only">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePlanting}
                                    type="checkbox"
                                    id="basic-planting-only"
                                    name="planting"
                                    value="Planting"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-planting-only">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePruning}
                                    type="checkbox"
                                    id="basic-pruning-only"
                                    name="pruning"
                                    value="Pruning"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="basic-pruning-only">
                                    pruning
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateKnotweed}
                                    type="checkbox"
                                    id="basic-knotweed-only"
                                    name="knotweed"
                                    value="Japanese Knotweed removal"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label w-100 japanese" htmlFor="basic-knotweed-only">
                                    japanese knotweed removal
                </label>
                            </div>
                        </div>
