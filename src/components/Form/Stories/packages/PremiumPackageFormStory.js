...
let choiceArr = ["Sky Premium Package"];

export default class PremiumPackageFormStory extends Component {
    constructor() {
        super();
        this.state = {
            ...
            <div className="form-section package-story-form py-5">
              ...
              {this.state.variant === "" &&
                                ...
                                choiceArr.reduce((res, k, i) =>
                                    [res, k].join(i === choiceArr.length - 1 ? " and " : ", ")
                                )}
                        </p>
                ...
                >
                    <div className={this.state.popup ? "form-popup" : "d-none"}>
                        <div className="col-12 text-center d-flex flex-column justify-content-center align-items-center h-100">
                            <img src={FlowerImg} alt="flower" className="flower-img rotate-center" />
                            <p>your message is being processed</p>
                        </div>
                    </div>

                    <div className={this.state.popupSuccess ? "form-popup" : "d-none"}>
                        <div className="col-12 text-center d-flex flex-column justify-content-around align-items-center">
                            ...
                            <p className="lead">click anywhere to close this window</p>
                        </div>
                    </div>
                </div>
            </div>
