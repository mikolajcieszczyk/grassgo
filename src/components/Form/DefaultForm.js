            ...
            <div className="col-12 col-md-5 col-lg-4">
              <div>
                <input
                  ...
                  value="CleanUp"
                />
                <label className="ml-3 form-label" htmlFor="cleanup">
                  cleanup
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Hedge Trim"
                />
                <label className="ml-3 form-label" htmlFor="hedgeTrim">
                  hedge trim
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Tree Surgery"
                />
                <label className="ml-3 form-label" htmlFor="treeSurgery">
                  tree surgery
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Lawn care"
                />
                <label className="ml-3 form-label" htmlFor="lawnCare">
                  lawn care
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Planting"
                />
                <label className="ml-3 form-label" htmlFor="planting">
                  planting
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Pruning"
                />
                <label className="ml-3 form-label" htmlFor="pruning">
                  pruning
                </label>
              </div>
