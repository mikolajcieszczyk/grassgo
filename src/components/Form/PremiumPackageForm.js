...
export default class PremiumPackageForm extends Component {
  constructor() {
    super();
    this.state = {
      ...
      whichPackage: "Sky Premium Package",
            ...
            <div className="col-12 col-md-5 col-lg-4">
              <div>
                <input
                  ...
                  value="CleanUp"
                />
                <label className="ml-3 form-label" htmlFor="premiumCleanup">
                  cleanup
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  class="my-checkbox styled-checkbox"
                  name="premiumHedgeTrim"
                  id="premiumHedgeTrim"
                  value="Hedge Trim"
                />
                <label className="ml-3 form-label" htmlFor="premiumHedgeTrim">
                  hedge trim
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  class="my-checkbox styled-checkbox"
                  id="premiumTreeSurgery"
                  name="premiumTreeSurgery"
                  value="Tree Surgery"
                />
                <label className="ml-3 form-label" htmlFor="premiumTreeSurgery">
                  tree surgery
                </label>
              </div>
              <div>
                <input
                  ...
                  class="my-checkbox styled-checkbox"
                  id="premiumLawnCare"
                  name="premiumLawnCare"
                  value="Lawn care"
                />
                <label className="ml-3 form-label" htmlFor="premiumLawnCare">
                  lawn care
                </label>
              </div>
              <div>
                <input
                  ...
                  class="my-checkbox styled-checkbox"
                  id="premiumPlanting"
                  name="premiumPlanting"
                  value="Planting"
                />
                <label className="ml-3 form-label" htmlFor="premiumPlanting">
                  planting
                </label>
              </div>
              <div>
                <input
                  ...
                  value="Pruning"
                />
                <label className="ml-3 form-label" htmlFor="premiumPruning">
                  pruning
                </label>
              </div>
              <div>
