...
export default class OneOffForm extends Component {
    constructor() {
        super();
        this.state = {
            ...
            whichService: "One-Off Services",
            whichPackage: "One-Off Services",
            ...
            <>
                <div className="form-section package-story-form py-5">
                    ...
                    >
                        ...
                        <p className="p-tellUs text-center">
                            Please, tell us which one do you choose:
            </p>
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    ...
                                    value="CleanUp"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffCleanup">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    class="my-checkbox styled-checkbox"
                                    id="oneoffHedgeTrim"
                                    name="oneoffHedgeTrim"
                                    value="Hedge Trim"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffHedgeTrim">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    type="checkbox"
                                    class="my-checkbox styled-checkbox"
                                    name="oneoffTreeSurgery"
                                    id="oneoffTreeSurgery"
                                    value="Tree Surgery"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffTreeSurgery">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Lawn care"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffLawnCare">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Planting"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffPlanting">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    ...
                                    value="Pruning"
                                />
                                <label className="ml-3 form-label" htmlFor="oneoffPruning">
                                    pruning
                </label>
                            </div>
                            <div>
                                ...
                                />
                                <label className="ml-3 form-label japanese w-100" htmlFor="oneoffKnotweed">
                        ...
                        <div className="col-12 col-md-5 col-lg-4">
                            <div>
                                <input
                                    onClick={this.translateCleanup}
                                    type="checkbox"
                                    id="oneoff-cleanup-only"
                                    name="cleanup"
                                    value="CleanUp"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-cleanup-only">
                                    cleanup
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateHedgeTrim}
                                    type="checkbox"
                                    id="oneoff-hedgeTrim-only"
                                    name="hedgeTrim"
                                    value="Hedge Trim"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-hedgeTrim-only">
                                    hedge trim
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateTreeSurgery}
                                    type="checkbox"
                                    id="oneoff-treeSurgery-only"
                                    name="treeSurgery"
                                    value="Tree Surgery"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-treeSurgery-only">
                                    tree surgery
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateLawnCare}
                                    type="checkbox"
                                    id="oneoff-lawnCare-only"
                                    name="lawnCare"
                                    value="Lawn care"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-lawnCare-only">
                                    lawn care
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePlanting}
                                    type="checkbox"
                                    id="oneoff-planting-only"
                                    name="planting"
                                    value="Planting"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-planting-only">
                                    planting
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translatePruning}
                                    type="checkbox"
                                    id="oneoff-pruning-only"
                                    name="pruning"
                                    value="Pruning"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label" htmlFor="oneoff-pruning-only">
                                    pruning
                </label>
                            </div>
                            <div>
                                <input
                                    onClick={this.translateKnotweed}
                                    type="checkbox"
                                    id="oneoff-knotweed-only"
                                    name="knotweed"
                                    value="Japanese Knotweed removal"
                                    class="my-checkbox styled-checkbox"
                                />
                                <label className="ml-2 form-label w-100 japanese" htmlFor="oneoff-knotweed-only">
                                    japanese knotweed removal
                </label>
                            </div>
                        </div>
