          ...
          >
            ...
            <div className="col-12 col-md-5 col-lg-4">
              ...
              <div>
                ...
                <label
                  className="ml-3 form-label"
                  htmlFor="intermediateTreeSurgery"
                >
                  tree surgery
                </label>
              </div>
            ...
            <div className="col-12 col-md-5 col-lg-4">
              <div>
                ...
                <label
                  ...
                  htmlFor="intermediate-cleanup-only"
                >
                  cleanup
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="intermediate-hedgeTrim-only"
                >
                  hedge trim
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="intermediate-treeSurgery-only"
                >
                  tree surgery
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="intermediate-lawnCare-only"
                >
                  lawn care
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="intermediate-planting-only"
                >
                  planting
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="intermediate-pruning-only"
                >
                  pruning
                </label>
              </div>
              <div>
                ...
                <label
                  ...
                  htmlFor="intermediate-knotweed-only"
                >
                  japanese knotweed removal
                </label>
              </div>
