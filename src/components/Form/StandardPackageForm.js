...
export default class StandardPackageForm extends Component {
  constructor() {
    super();
    this.state = {
      ...
      whichPackage: "Sea Standard Package",
          ...
          >
            ...
            <div className="col-10 col-lg-4">
              <input
                ...
                value="Package"
              />
              <label className="ml-3 form-label" htmlFor="package-standard">
                package
              </label>
            </div>
            <div className="col-10 col-lg-4">
              ...
              />
              <label className="ml-3 form-label" htmlFor="oneoff-standard">
                one off
              </label>
            </div>
            <div className="col-10 col-lg-4">
              <input
                onClick={this.whichServiceCatcher}
                type="radio"
                id="commercialpublic-standard"
                name="whichServiceName"
                value="Commercial and public space"
              />
              <label
                className="ml-3 form-label"
                htmlFor="commercialpublic-standard"
              >
          ...
          >
            ...
            <div className="col-10 col-md-5 col-lg-4">
              <input
                ...
                type="radio"
                id="standardpackage-standard"
                name="whichPackageName"
                value="Sea Standard Package"
              />
              <label
                className="ml-3 form-label"
                htmlFor="standardpackage-standard"
              >
            ...
            <div className="col-10 col-md-5 col-lg-4">
              <input
                onClick={this.whichPackageCatcher}
                type="radio"
                id="premiumpackage-standard"
                name="whichPackageName"
                value="Sky Premium Package"
              />
              <label
                className="ml-3 form-label"
                htmlFor="premiumpackage-standard"
              >
                Sky Premium Package
              </label>
            </div>
            <div className="col-10 col-md-5 col-lg-4 ml-4">
              ...
              <input
                ...
                onClick={this.whichPackageCatcher}
                type="radio"
                id="ecopackageBasic-standard"
                name="whichPackageName"
                value="Earth Eco Package: BASIC"
              />
              <label
                className="ml-3 form-label"
                htmlFor="ecopackageBasic-standard"
              >
                Basic
              </label>
              ...
              <input
                ...
                onClick={this.whichPackageCatcher}
                type="radio"
                id="ecopackageIntermediate-standard"
                name="whichPackageName"
                value="Earth Eco Package: INTERMEDIATE"
              />
              <label
                className="ml-3 form-label"
                htmlFor="ecopackageIntermediate-standard"
              >
                Intermediate
              </label>
              ...
              <input
                ...
                onClick={this.whichPackageCatcher}
                type="radio"
                id="ecopackageAdvanced-standard"
                name="whichPackageName"
                value="Earth Eco Package: ADVANCED"
              />
              <label
                className="ml-3 form-label"
                htmlFor="ecopackageAdvanced-standard"
              >
                Advanced
              </label>
            </div>
            ...
            <div className="col-12 col-md-5 col-lg-4">
              <div>
                <input
                  ...
                  id="standardCleanup"
                  name="standardCleanup"
                  value="CleanUp"
                />
                <label className="ml-3 form-label" htmlFor="standardCleanup">
                  cleanup
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  className="my-checkbox styled-checkbox"
                  id="standardHedgeTrim"
                  name="standardHedgeTrim"
                  value="Hedge Trim"
                />
                <label className="ml-3 form-label" htmlFor="standardHedgeTrim">
                  hedge trim
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  className="my-checkbox styled-checkbox"
                  name="standardTreeSurgery"
                  id="standardTreeSurgery"
                  value="Tree Surgery"
                />
                <label
                  className="ml-3 form-label"
                  htmlFor="standardTreeSurgery"
                >
                  tree surgery
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  className="my-checkbox styled-checkbox"
                  name="standardLawnCare"
                  id="standardLawnCare"
                  value="Lawn care"
                />
                <label className="ml-3 form-label" htmlFor="standardLawnCare">
                  lawn care
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  className="my-checkbox styled-checkbox"
                  name="standardPlanting"
                  id="standardPlanting"
                  value="Planting"
                />
                <label className="ml-3 form-label" htmlFor="standardPlanting">
                  planting
                </label>
              </div>
              <div>
                <input
                  ...
                  type="checkbox"
                  className="my-checkbox styled-checkbox"
                  name="standardPruning"
                  id="standardPruning"
                  value="Pruning"
                />
                <label className="ml-3 form-label" htmlFor="standardPruning">
                  pruning
                </label>
              </div>
              <div>
          ...
          >
            ...
            <div className="col-12 col-md-5 col-lg-4">
              ...
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="standard-hedgeTrim-only"
                >
                  hedge trim
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="standard-treeSurgery-only"
                >
                  tree surgery
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="standard-lawnCare-only"
                >
                  lawn care
                </label>
              </div>
              <div>
                ...
                <label
                  className="ml-2 form-label"
                  htmlFor="standard-planting-only"
                >
                  planting
                </label>
              </div>
              ...
              <div>
                ...
                <label
                  ...
                  htmlFor="standard-knotweed-only"
                >
                  japanese knotweed removal
                </label>
              </div>
              <div className="d-flex flex-column">
                <label className="ml-2 form-label" htmlFor="other">
                  other:
                </label>
                <input
                  onChange={(e) => this.setState({ other: e.target.value })}
